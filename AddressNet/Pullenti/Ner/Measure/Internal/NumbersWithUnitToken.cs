...
namespace Pullenti.Ner.Measure.Internal
{
    ...
    public class NumbersWithUnitToken : Pullenti.Ner.MetaToken
    {
        ...
        public string ToStringEx(bool ignoreUnits = false)
        {
        ...
        internal static NumbersWithUnitToken _tryParse(Pullenti.Ner.Token t, Pullenti.Ner.Core.TerminCollection addUnits, NumberWithUnitParseAttr attrs)
        {
            ...
            Pullenti.Ner.NumberToken num = Pullenti.Ner.Core.NumberHelper.TryParseRealNumber(t, Pullenti.Ner.Core.NumberParseAttr.No);
            if (num == null) 
            {
                uni = UnitToken.TryParseList(t, addUnits, false);
                if (uni != null) 
                {
                    ...
                    num = Pullenti.Ner.Core.NumberHelper.TryParseRealNumber(t, Pullenti.Ner.Core.NumberParseAttr.No);
            ...
            else 
            {
                ...
                {
                    num = Pullenti.Ner.Core.NumberHelper.TryParseRealNumber(t.Next, Pullenti.Ner.Core.NumberParseAttr.No);
                    if (num == null) 
                        return null;
                }
