...
namespace Pullenti.Ner.Measure.Internal
{
    public static class UnitsHelper
    {
        ...
        public static void Initialize()
        {
            ...
            u.Keywords.AddRange(new string[] {"ДЛИНА", "ДЛИННА", "ШИРИНА", "ГЛУБИНА", "ВЫСОТА", "РАЗМЕР", "ГАБАРИТ", "РАССТОЯНИЕ", "РАДИУС", "ПЕРИМЕТР", "ДИАМЕТР", "ТОЛЩИНА", "ПОДАЧА", "НАПОР", "ДАЛЬНОСТЬ", "ТИПОРАЗМЕР", "КАЛИБР", "СЕЧЕНИЕ", "LENGTH", "WIDTH", "DEPTH", "HEIGHT", "SIZE", "ENVELOPE", "DISTANCE", "RADIUS", "PERIMETER", "DIAMETER", "FLOW", "PRESSURE", "CALIBER", "ДОВЖИНА", "ШИРИНА", "ГЛИБИНА", "ВИСОТА", "РОЗМІР", "ГАБАРИТ", "ВІДСТАНЬ", "РАДІУС", "ДІАМЕТР", "НАТИСК", "КАЛІБР", "ПЕРЕРІЗ"});
            Units.Add(u);
            ...
            Termins.Add(t);
            uDay = (u = new Unit("дн", "d", "день", "day") { Kind = Pullenti.Ner.Measure.MeasureKind.Time });
            ...
            Units.Add(u);
            u.Keywords.AddRange(new string[] {"УГОЛ"});
            t = new Pullenti.Ner.Core.Termin("РАДИАН") { Tag = u };
            t.AddVariant("РАД", false);
            t.AddVariant("RADIAN", false);
            t.AddVariant("RAD", false);
            Termins.Add(t);
            uGradus = new Unit("°", "°", "градус", "degree");
            uGradus.Keywords.AddRange(new string[] {"ТЕМПЕРАТУРА", "ШИРОТА", "ДОЛГОТА", "АЗИМУТ", "TEMPERATURE", "LATITUDE", "LONGITUDE", "AZIMUTH"});
            Units.Add(uGradus);
            ...
            uu.Keywords.AddRange(new string[] {"РАБОТА", "ЭНЕРГИЯ", "ТЕПЛОТА", "ТЕПЛОВОЙ", "ТЕПЛОВЫДЕЛЕНИЕ", "МОЩНОСТЬ", "ХОЛОДИЛЬНЫЙ", "ЭНТАЛЬПИЯ"});
            Units.Add(uu);
            t = new Pullenti.Ner.Core.Termin("КАЛОРИЯ") { Tag = uu };
            t.AddAbridge("КАЛ");
            t.AddAbridge("CAL");
            t.AddVariant("CALORIE", false);
            t.AddVariant("КАЛОРІЯ", false);
            Termins.Add(t);
            foreach (UnitsFactors f in new UnitsFactors[] {UnitsFactors.Kilo, UnitsFactors.Mega, UnitsFactors.Giga}) 
            {
            ...
            u.Keywords.AddRange(new string[] {"ЭЛЕКТРИЧЕСКИЙ ЗАРЯД", "ИНДУКЦИЯ", "ЭЛЕКТРИЧЕСТВО", "ЕЛЕКТРИЧНИЙ ЗАРЯД", "ІНДУКЦІЯ", "ЕЛЕКТРИКА", "ELECTRIC CHARGE", "INDUCTION", "ELECTRICITY"});
            Units.Add(u);
            t = new Pullenti.Ner.Core.Termin("КУЛОН") { Tag = u };
            t.AddAbridge("КЛ");
            t.AddAbridge("C");
            ...
            {
                Unit u1 = _addFactor(f, u, "КЛ", "C", "КУЛОН", "КУЛОН", "COULOMB");
            }
            u = new Unit("Вб", "Wb", "вебер", "weber");
            u.Keywords.AddRange(new string[] {"МАГНИТНЫЙ ПОТОК", "МАГНИТ", "МАГНІТНИЙ ПОТІК", "МАГНІТ", "MAGNETIC FLUX", "MAGNET"});
            Units.Add(u);
            t = new Pullenti.Ner.Core.Termin("ВЕБЕР") { Tag = u };
            t.AddAbridge("ВБ");
            t.AddAbridge("WB");
            ...
            foreach (UnitsFactors f in new UnitsFactors[] {UnitsFactors.Kilo, UnitsFactors.Mega, UnitsFactors.Giga, UnitsFactors.Deci, UnitsFactors.Centi, UnitsFactors.Micro, UnitsFactors.Milli, UnitsFactors.Nano}) 
            {
                Unit u1 = _addFactor(f, u, "ВБ", "WB", "ВЕБЕР", "ВЕБЕР", "WEBER");
            }
            u = new Unit("Тл", "T", "тесла", "tesla");
            u.Keywords.AddRange(new string[] {"ИНДУКЦИЯ", "МАГНИТНОЕ ПОЛЕ", "INDUCTION", "MAGNETIC FIELD", "ІНДУКЦІЯ", "МАГНІТНЕ ПОЛЕ"});
            Units.Add(u);
            t = new Pullenti.Ner.Core.Termin("ТЕСЛА") { Tag = u };
            t.AddAbridge("ТЛ");
            t.AddAbridge("T");
            ...
            foreach (UnitsFactors f in new UnitsFactors[] {UnitsFactors.Kilo, UnitsFactors.Mega, UnitsFactors.Giga, UnitsFactors.Deci, UnitsFactors.Centi, UnitsFactors.Micro, UnitsFactors.Milli, UnitsFactors.Nano}) 
            {
                Unit u1 = _addFactor(f, u, "ТЛ", "T", "ТЕСЛА", "ТЕСЛА", "TESLA");
            }
            u = new Unit("Гн", "H", "генри", "henry");
            u.Keywords.AddRange(new string[] {"ИНДУКЦИЯ", "ИНДУКТИВНОСТЬ", "ЭДС", "ІНДУКЦІЯ", "ІНДУКТИВНІСТЬ", "INDUCTION", "INDUCTANCE"});
            Units.Add(u);
            t = new Pullenti.Ner.Core.Termin("ГЕНРИ") { Tag = u };
            t.AddAbridge("ГН");
            t.AddAbridge("H");
            ...
            foreach (UnitsFactors f in new UnitsFactors[] {UnitsFactors.Kilo, UnitsFactors.Mega, UnitsFactors.Giga, UnitsFactors.Deci, UnitsFactors.Centi, UnitsFactors.Micro, UnitsFactors.Milli, UnitsFactors.Nano}) 
            {
                Unit u1 = _addFactor(f, u, "ГН", "H", "ГЕНРИ", "ГЕНРИ", "HENRY");
            }
            u = new Unit("Гр", "Gy", "грей", "gray");
            u.Keywords.AddRange(new string[] {"ПОГЛОЩЕНИЕ", "ИЗЛУЧЕНИЕ", "ABSORPTION", "RADIATION", "ПОГЛИНАННЯ", "ВИПРОМІНЮВАННЯ"});
            Units.Add(u);
            t = new Pullenti.Ner.Core.Termin("ГРЕЙ") { Tag = u };
            t.AddAbridge("ГР");
            t.AddAbridge("GY");
            ...
            foreach (UnitsFactors f in new UnitsFactors[] {UnitsFactors.Kilo, UnitsFactors.Mega, UnitsFactors.Giga, UnitsFactors.Deci, UnitsFactors.Centi, UnitsFactors.Micro, UnitsFactors.Milli, UnitsFactors.Nano}) 
            {
                Unit u1 = _addFactor(f, u, "ГР", "GY", "ГРЕЙ", "ГРЕЙ", "GRAY");
            }
            u = new Unit("Зв", "Sv", "зиверт", "sievert");
            u.Keywords.AddRange(new string[] {"ДОЗА", "ИЗЛУЧЕНИЕ", "DOSE", "RADIATION", "ВИПРОМІНЮВАННЯ"});
            Units.Add(u);
            t = new Pullenti.Ner.Core.Termin("ЗИВЕРТ") { Tag = u };
            t.AddAbridge("ЗВ");
            t.AddAbridge("SV");
            ...
            foreach (UnitsFactors f in new UnitsFactors[] {UnitsFactors.Kilo, UnitsFactors.Mega, UnitsFactors.Giga, UnitsFactors.Deci, UnitsFactors.Centi, UnitsFactors.Micro, UnitsFactors.Milli, UnitsFactors.Nano}) 
            {
                Unit u1 = _addFactor(f, u, "ЗВ", "SV", "ЗИВЕРТ", "ЗІВЕРТ", "SIEVERT");
            }
            u = new Unit("кат", "kat", "катал", "katal");
            u.Keywords.AddRange(new string[] {"АКТИВНОСТЬ", "КАТАЛИЗАТОР", "ACTIVITY", "CATALYST", "АКТИВНІСТЬ", "КАТАЛІЗАТОР"});
            Units.Add(u);
            t = new Pullenti.Ner.Core.Termin("КАТАЛ") { Tag = u };
            t.AddAbridge("КАТ");
            t.AddAbridge("KAT");
            ...
            foreach (UnitsFactors f in new UnitsFactors[] {UnitsFactors.Kilo, UnitsFactors.Mega, UnitsFactors.Giga, UnitsFactors.Deci, UnitsFactors.Centi, UnitsFactors.Micro, UnitsFactors.Milli, UnitsFactors.Nano}) 
            {
                Unit u1 = _addFactor(f, u, "КАТ", "KAT", "КАТАЛ", "КАТАЛ", "KATAL");
            }
            ...
            u.Keywords.AddRange(new string[] {"СВЕТ", "ОСВЕЩЕННОСТЬ", "СВЕТОВОЙ ПОТОК", "ПОТОК СВЕТА", "VISIBLE LIGHT", "ILLUMINANCE", "СВІТЛО", " ОСВІТЛЕНІСТЬ"});
            Units.Add(u);
            t = new Pullenti.Ner.Core.Termin("ЛЮМЕН") { Tag = u };
            t.AddAbridge("ЛМ");
            t.AddAbridge("LM");
            t.AddVariant("LUMEN", false);
            Termins.Add(t);
            foreach (UnitsFactors f in new UnitsFactors[] {UnitsFactors.Kilo, UnitsFactors.Mega, UnitsFactors.Giga, UnitsFactors.Tera, UnitsFactors.Deci, UnitsFactors.Centi, UnitsFactors.Micro, UnitsFactors.Milli, UnitsFactors.Nano, UnitsFactors.Pico}) 
            {
                Unit u1 = _addFactor(f, u, "ЛМ", "LM", "ЛЮМЕН", "ЛЮМЕН", "LUMEN");
            }
            ...
            Termins.Add(t);
            u = new Unit("кгU", "kgU", "килограмм урана", "kgU") { Kind = Pullenti.Ner.Measure.MeasureKind.Weight };
            Units.Add(u);
            t = new Pullenti.Ner.Core.Termin("КГU") { Tag = u };
            t.AddVariant("КГ U", false);
            t.AddVariant("КИЛОГРАММ УРАНА", false);
            t.AddVariant("KGU", false);
            t.AddVariant("KG U", false);
            Termins.Add(t);
            u = new Unit("кг", "kgZr", "килограмм циркония", "kgZr") { Kind = Pullenti.Ner.Measure.MeasureKind.Weight };
            Units.Add(u);
            t = new Pullenti.Ner.Core.Termin("КГZR") { Tag = u };
