...
namespace Pullenti.Ner
{
    ...
    public class Referent
    {
        ...
        {
            return this.ToStringEx(false, Pullenti.Morph.MorphLang.Unknown, 0);
        }
        /// <summary>
        ...
        public virtual string ToStringEx(bool shortVariant, Pullenti.Morph.MorphLang lang = null, int lev = 0)
        {
            return TypeName;
        }
                ...
                if (s != null && mergeStatistic) 
                {
                    ...
                    if (r.Occurrence != null) 
                    {
                        if (s.Occurrence == null) 
                            s.Occurrence = new List<TextAnnotation>();
                        foreach (TextAnnotation o in r.Occurrence) 
                        {
                            s.Occurrence.Add(o);
                        }
                    }
        ...
        public virtual List<string> GetCompareStrings()
        {
            ...
            string s = this.ToStringEx(true, Pullenti.Morph.MorphLang.Unknown, 0);
            if (s != res[0]) 
                res.Add(s);
            return res;
        }
