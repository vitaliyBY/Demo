...
namespace Pullenti.Ner.Address.Internal
{
    class MetaAddress : Pullenti.Ner.Metadata.ReferentClass
    {
        public static void Initialize()
        {
            ...
            GlobalMeta.HouseTypeFeature.AddValue(Pullenti.Ner.Address.AddressHouseType.Special.ToString(), "Спец.строение", null, null);
            ...
            GlobalMeta.AddFeature(Pullenti.Ner.Address.AddressReferent.ATTR_GENPLAN, "Генплан", 0, 1);
            GlobalMeta.AddFeature(Pullenti.Ner.Address.AddressReferent.ATTR_BLOCK, "Блок", 0, 1);
            GlobalMeta.AddFeature(Pullenti.Ner.Address.AddressReferent.ATTR_BOX, "Гараж", 0, 1);
            GlobalMeta.AddFeature(Pullenti.Ner.Address.AddressReferent.ATTR_WELL, "Скважина", 0, 1);
            GlobalMeta.AddFeature(Pullenti.Ner.Address.AddressReferent.ATTR_CARPLACE, "Машиноместо", 0, 1);
            GlobalMeta.AddFeature(Pullenti.Ner.Address.AddressReferent.ATTR_PART, "Часть", 0, 1);
            GlobalMeta.AddFeature(Pullenti.Ner.Address.AddressReferent.ATTR_PANTRY, "Кладовка", 0, 1);
            GlobalMeta.AddFeature(Pullenti.Ner.Address.AddressReferent.ATTR_ROOM, "Комната", 0, 1);
            GlobalMeta.AddFeature(Pullenti.Ner.Address.AddressReferent.ATTR_SPACE, "Помещение", 0, 1);
            ...
            GlobalMeta.AddFeature(Pullenti.Ner.Address.AddressReferent.ATTR_DELIVERYAREA, "Доставочный участок", 0, 1);
            ...
            detail.AddValue(Pullenti.Ner.Address.AddressDetailType.Right.ToString(), "Правее", null, null);
            detail.AddValue(Pullenti.Ner.Address.AddressDetailType.Left.ToString(), "Левее", null, null);
            ...
            detail.AddValue(Pullenti.Ner.Address.AddressDetailType.Central.ToString(), "Центральный", null, null);
            detail.AddValue(Pullenti.Ner.Address.AddressDetailType.Range.ToString(), "Диапазон", null, null);
