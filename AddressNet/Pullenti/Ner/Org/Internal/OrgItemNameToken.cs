        ...
        static OrgItemNameToken _TryAttach(Pullenti.Ner.Token t, OrgItemNameToken prev, bool extOnto)
        {
            ...
            if (r != null) 
            {
                if (r.TypeName == "DENOMINATION") 
                    return new OrgItemNameToken(t, t) { Value = r.ToStringEx(true, t.Kit.BaseLanguage, 0), IsDenomination = true };
            ...
            if (npt != null && npt.InternalNoun != null) 
                npt = null;
            else if ((npt != null && npt.Adjectives.Count > 0 && !npt.Adjectives[0].Chars.IsAllUpper) && npt.Noun.Chars.IsAllUpper) 
                npt = null;
            bool explOk = false;
