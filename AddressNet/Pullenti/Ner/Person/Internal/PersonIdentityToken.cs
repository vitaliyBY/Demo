...
namespace Pullenti.Ner.Person.Internal
{
    class PersonIdentityToken : Pullenti.Ner.MetaToken
    {
        ...
        public static List<PersonIdentityToken> TryAttach(List<PersonItemToken> pits, int ind, Pullenti.Morph.MorphBaseInfo inf, Pullenti.Ner.Token firstTok, bool king, bool isAttrBefore)
        {
            ...
            else 
            {
                ...
                if ((((pit1 = TryAttachNameSecnameSurname(pits, ind, inf, ty == FioTemplateType.NameSecnameSurname)))) != null) 
                {
                    ...
                    {
                        if (ind == 0 && pits.Count == 3) 
                            pit1.Coef = (float)((pit.Coef + 0.5));
                    }
                    res.Add(pit1);
                }
        ...
        static PersonIdentityToken TryAttachNameSurname(List<PersonItemToken> pits, int ind, Pullenti.Morph.MorphBaseInfo inf, bool prevHasThisTyp = false, bool isAttrBefore = false)
        {
            ...
            if ((ind == 0 && pits.Count == 3 && pits[2].Middlename != null) && pits[1].Firstname != null) 
                res.Coef--;
            return res;
        }
        static PersonIdentityToken TryAttachNameSecnameSurname(List<PersonItemToken> pits, int ind, Pullenti.Morph.MorphBaseInfo inf, bool prevHasThisTyp = false)
        {
            ...
            if (pits[ind + 1].BeginToken.Chars.IsAllUpper && !pits[ind + 2].BeginToken.Chars.IsAllUpper && pits[ind + 1].Typ == PersonItemToken.ItemType.Value) 
            {
            ...
            res.Coef -= ind;
            if (pits[ind + 1].Middlename != null && !pits[ind + 1].Middlename.Morph.Case.IsUndefined) 
            {
                if (((inf.Case & pits[ind + 1].Middlename.Morph.Case)).IsUndefined) 
                    inf = new Pullenti.Morph.MorphBaseInfo();
            }
        ...
        static PersonIdentityToken TryAttachSurnameName(List<PersonItemToken> pits, int ind, Pullenti.Morph.MorphBaseInfo inf, bool prevHasThisTyp = false)
        {
            ...
            if (pits.Count == 2 && ind == 0 && pits[1].BeginToken.IsValue("ЛАВРА", null)) 
            {
                if (pits[0].EndToken.Morph.Class.IsAdjective) 
                    return null;
            }
            return res;
        }
        ...
        static PersonIdentityToken TryAttachSurnameNameSecname(List<PersonItemToken> pits, int ind, Pullenti.Morph.MorphBaseInfo inf, bool prevHasThisTyp = false, bool always = false)
        {
            ...
            if (pits[ind + 2].BeginToken.Chars.IsAllUpper && !pits[ind].BeginToken.Chars.IsAllUpper && pits[ind + 2].Typ == PersonItemToken.ItemType.Value) 
            {
            ...
            if (pits[ind + 2].Middlename != null && !pits[ind + 2].Middlename.Morph.Case.IsUndefined) 
            {
                if (((inf.Case & pits[ind + 2].Middlename.Morph.Case)).IsUndefined) 
                    inf = new Pullenti.Morph.MorphBaseInfo();
            }
