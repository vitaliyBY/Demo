...
namespace Pullenti.Semantic.Utils
{
    ...
    {
        /// <summary>
        /// Слова дериватной группы - неупорядоченный список DerivateWord. 
        /// Но обычно первым идёт существительное на русском языке, если есть. 
        /// Первое слово можно использовать для "супернормализации".
        /// </summary>
